    function pesquisaClienteController($scope, $http, $compile, $injector, $cookieStore) {


       $scope.delete = function(id) {
        console.log("pesquisaClienteController :delete");
           console.log(id);
           $cookieStore.put('deletecliente', id);
       }

       $scope.editar = function(id) {
        console.log("pesquisaClienteController :editar");
           console.log(id);
           $cookieStore.put('editarcliente', id);
       }
       $scope.gerarcartaocpf = function(cliente) {
        console.log("pesquisaClienteController :gerarcartaocpf");
       ...
       $scope.gerarcartaocnpj = function(cliente) {
        console.log("pesquisaClienteController :gerarcartaocnpj");
           // SE TEM REGISTRO NA BUSCA
           var $newDiv = $("<div class='row'>" +
               "<div class='col s6 '>" +
               "<div class='card blue-grey darken-1'>" +
       ...
       $scope.gerarcartaonome = function(cliente) {
        console.log("pesquisaClienteController :gerarcartaonome");
           // SE TEM REGISTRO NA BUSCA
           var $newDiv = $("<div class='row'>" +
               "<div class='col s6 '>" +
               "<div class='card blue-grey darken-1'>" +
       ...
       $scope.pesquisar = function() {
          console.log("pesquisaClienteController :pesquisar");
           var request = $http({
               method: "post",
       ...
       $scope.pesquisarcpf = function() {
        console.log("pesquisaClienteController :pesquisarcpf");
       ...
       $scope.pesquisarnome = function() {
        console.log("pesquisaClienteController :pesquisarnome");
       ...
       $scope.pesquisarcnpj = function() {
        console.log("pesquisaClienteController :pesquisarcnpj");
