    function pesquisaProdutoController($scope, $http, $compile, $injector, $cookieStore) {
       ...
       $scope.delete = function(id) {
        console.log("pesquisaProdutoController :delete");
           console.log(id);
           $cookieStore.put('deleteproduto', id);
       }

       $scope.editar = function(id) {
        console.log("pesquisaProdutoController :editar");
           console.log(id);
           $cookieStore.put('editarproduto', id);
       }

       $scope.gerarcartaonome = function(produto) {
         console.log("pesquisaProdutoController :gerarcartaonome");
       ...
       $scope.pesquisar = function() {
        console.log("pesquisaProdutoController :pesquisar");
           var request = $http({
               method: "post",
       ...
       $scope.pesquisarnome = function() {
        console.log("pesquisaProdutoController :pesquisarnome");
