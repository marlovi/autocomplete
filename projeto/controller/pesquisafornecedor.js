    function pesquisaFornecedorController($scope, $http, $compile, $injector, $cookieStore) {
       ...
       $scope.delete = function(id) {
        console.log("pesquisaFornecedorController :delete");
           console.log(id);
           $cookieStore.put('deletefornecedor', id);
       }

       $scope.editar = function(id) {
        console.log("pesquisaFornecedorController :editar");
           console.log(id);
           $cookieStore.put('editarfornecedor', id);
       }

       $scope.gerarcartaocpf = function(fornecedor) {
        console.log("pesquisaFornecedorController :gerarcartaocpf");
       ...
       $scope.gerarcartaocnpj = function(fornecedor) {
         console.log("pesquisaFornecedorController :gerarcartaocnpj");
       ...
       $scope.gerarcartaonome = function(fornecedor) {
         console.log("pesquisaFornecedorController :gerarcartaonome");
       ...
       $scope.pesquisar = function() {
        console.log("pesquisaFornecedorController :pesquisar");
           var request = $http({
               method: "post",
       ...
       $scope.pesquisarcpf = function() {
         console.log("pesquisaFornecedorController :pesquisarcpf");
       ...
       $scope.pesquisarnome = function() {
        console.log("pesquisaFornecedorController :pesquisarnome");
       ...
       $scope.pesquisarcnpj = function() {
        console.log("pesquisaFornecedorController :pesquisarcnpj");
