  function deleteClienteController($scope, $http, $cookieStore, focus, $timeout, meuServico) {
     ...
     $scope.deletar = function() {
        console.log("deleteClienteController :deletar");
     ...
     $scope.doSomething = function() {
        console.log("deleteClienteController :doSomething");
         focus('nome');
         focus("cpf");
         focus("cnpj");
         focus("endereco");
     ...
     $scope.teste = function() {
        console.log("deleteClienteController :teste");
         console.log($cookieStore.get('deletecliente'));
     }

     $scope.salvarVeiculo = function() {
        console.log("deleteClienteController :salvarVeiculo");
     ...
     $scope.buscarVeiculos = function() {
        console.log("deleteClienteController :buscarVeiculos");
         var request = $http({
             method: "post",
     ...
     function clickOnUpload() {
         console.log("deleteClienteController :clickOnUpload");
         $timeout(function() {
