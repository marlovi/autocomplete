  function editarEmpresaController($scope, $http, $cookieStore, focus, $timeout, meuServico) {
     ...
     $scope.editar = function() {
        console.log("editarEmpresaController :editar");
     ...
     $scope.doSomething = function() {
        console.log("editarEmpresaController :doSomething");
     ...
     $scope.teste = function() {
        console.log("editarEmpresaController :teste");
         console.log($cookieStore.get('editarempresa'));
     }

     // DEVE SER EDITADA!!!
     $scope.salvarVeiculo = function() {
         console.log("editarEmpresaController :salvarVeiculo");
     ...
     $scope.buscarVeiculos = function() {
        console.log("editarEmpresaController :buscarVeiculos");
         var request = $http({
             method: "post",
     ...
     function clickOnUpload() {
        console.log("editarEmpresaController :clickOnUpload");
         $timeout(function() {
