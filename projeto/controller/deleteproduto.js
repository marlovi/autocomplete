  function deleteProdutoController($scope, $http, $cookieStore, focus, $timeout, meuServico) {
     ...
     $scope.deletar = function() {
        console.log("deleteProdutoController :deletar");
     ...
     $scope.doSomething = function() {
        console.log("deleteProdutoController :doSomething");
     ...
     $scope.teste = function() {
        console.log("deleteProdutoController :teste");
         console.log($cookieStore.get('deleteproduto'));
     }

     function clickOnUpload() {
        console.log("deleteProdutoController :clickOnUpload");
         $timeout(function() {
