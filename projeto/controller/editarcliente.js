  function editarClienteController($scope, $http, $cookieStore, focus, $timeout, $mdDialog, meuServico) {
     ...
     $scope.openOffscreen = function() {
        console.log("editarClienteController :openOffscreen");
         $mdDialog.show(
             $mdDialog.alert()
     ...
     $scope.editar = function() {
        console.log("editarClienteController :editar");
     ...
     $scope.doSomething = function() {
        console.log("editarClienteController :doSomething");
     ...
     $scope.teste = function() {
        console.log("editarClienteController :teste");
         console.log($cookieStore.get('editarcliente'));
     }
     $scope.salvarVeiculo = function() {
        console.log("editarClienteController :salvarVeiculo");
     ...
     $scope.consulta_placa = function() {
        console.log("editarClienteController :consulta_placa");
     ...
     $scope.buscarVeiculos = function() {
        console.log("editarClienteController :buscarVeiculos");
         var request = $http({
             method: "post",
     ...
     function clickOnUpload() {
        console.log("editarClienteController :clickOnUpload");
         $timeout(function() {
